      ...
      {selectedRepo ? (
        <div className="mt-4">
          ...
          <div className="rounded-xl bg-gray-50 p-2 shadow-sm">
            ...
            > <strong>Descrição:</strong><h2 className='text-gray-500'>{selectedRepo.description || 'Sem descrição'}</h2> 
            </p>

            <p className={`${lusitana.className}
                truncate rounded-xl bg-white px-4 py-8 text-center text-2xl`}><strong>Estrelas:</strong><h2 className='text-gray-500'>
